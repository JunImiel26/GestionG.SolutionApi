...
namespace GestionG.Infrastructure.Migrations
{
    ...
    public partial class InitialMigration_V2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdGasto = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TotalGeneral = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Detalles_Categorias_IdCat",
                        column: x => x.IdCat,
                        principalTable: "Categorias",
                        principalColumn: "IdCat",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Detalles_Gastos_IdGasto",
                        column: x => x.IdGasto,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Detalles_IdCat",
                table: "Detalles",
                column: "IdCat");

            migrationBuilder.CreateIndex(
                name: "IX_Detalles_IdGasto",
                table: "Detalles",
                column: "IdGasto");
